                                 ...
                                 int16_t lowlevelSignal)
{
    ...
    for (k = 0; k < 10; k++)
    {
		...
		//printf("stt->capacitorSlow=%d, stt->capacitorFast=%d\n", stt->capacitorSlow, stt->capacitorFast);
