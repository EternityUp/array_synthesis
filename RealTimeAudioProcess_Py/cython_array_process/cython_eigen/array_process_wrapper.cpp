...
void ArrayProcessSynthesis::ArrayProcessCore(float *in_multi_chs_data, float *out_single_ch_data)
{
    ...
    FloatToInt16_t(out_ch_audio_data, kFrameLen, out_frame_buf_int16);
    agc_ProcessCore(out_frame_buf_int16, out_frame_buf_int16, process_inst.agc_config);
    Int16_tToFloat(out_frame_buf_int16, kFrameLen, out_ch_audio_data);
